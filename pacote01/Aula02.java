...
public class Aula02 {
	...
	public static void main(String[] args) {
		...
		DateTimeFormatter format01 = DateTimeFormatter.ofPattern("dd/MM/yyy");
		DateTimeFormatter format02 = DateTimeFormatter.ofPattern("dd/MM/yyy HH:mm");
		...
		System.out.println("d11: " + d11);  // Alterando a data para 20/07/2022 01:30 com LocalDate.of (LocalDate)
	}
